...
var CognitoAuth = function () {
  ...
  _createClass(CognitoAuth, [{
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                tokenScopesInputSet = new _Set(this.TokenScopesArray);
                cachedScopesSet = new _Set(this.signInUserSession.tokenScopes.getScopes());
              ...
              case 5:
                ...
                tokenScopes = new CognitoTokenScopes(this.TokenScopesArray);
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(httpRequestResponse) {
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(map) {
    ...
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(map) {
    ...
    value: function compareSets(set1, set2) {
      ...
      try {
        for (var _iterator = _getIterator(set1), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: 'refreshSession',
    value: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(refreshToken) {
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(jsonData) {
    ...
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(jsonData) {
